...
public class PermissionController {
    ...
    @ResponseBody
    public Map<String, Object> allpermission(int page, int limit) {
    ...
    //编辑角色对应的权限
    @RequestMapping("permission/toedit/{r_p_id}")
    public ModelAndView permission_toedit(@PathVariable("r_p_id") String r_p_id) {
        ModelAndView modelAndView = new ModelAndView();
        //todo 查一条应该用实体去接受
        List<Role_Permission> role_permissionlist = permissionService.getRole_PermissionById(r_p_id);
